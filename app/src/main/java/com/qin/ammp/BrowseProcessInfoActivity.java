...
public class BrowseProcessInfoActivity extends Activity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        tvTotalProcessNo.setText("当前进程列表：");
    }
    ...
    */
    ...
    private void getRunningAppProcessInfo()
    {
        ...
        for (ActivityManager.RunningAppProcessInfo appProcessInfo : appProcessList)
        {
            ...
            if (processName.startsWith("com.android") || processName.startsWith("org.mozilla.firefox") || processName.startsWith("com.google.android"))
            {
                continue;
            }
            if (processName.startsWith("com.yulong") || processName.startsWith("com.koushikdutta.superuser") || processName.startsWith("android.process."))
            {
                continue;
            }
            // 获得该进程占用的内存
            ...
            Log.i(TAG, "processName: " + processName + "  pid: " + pid + " uid:" + uid + " memorySize is -->" + memSize + "kb");
            // 构造一个ProcessInfo对象
    ...
    public boolean onContextItemSelected(MenuItem item)
    {
        switch (item.getItemId())
        {
            case KILL_PORCESS: // 杀死该进程 ， 重新加载界面
                new AlertDialog.Builder(this).setMessage("是否杀死该进程").setPositiveButton("确定", new DialogInterface.OnClickListener()
                        {
                            @Override
                            public void onClick(DialogInterface dialog, int which)
                            {
